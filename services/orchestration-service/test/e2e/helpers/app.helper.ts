 ...
 * The orchestration_test database must exist before running the tests.
 * Create it once with:
 *   PGPASSWORD=visiomath_secret psql -h localhost -U visiomath \
 *     -c "CREATE DATABASE orchestration_test OWNER visiomath;"
 *
 * The orchestration-service reads individual DB_* env vars (not DATABASE_URL).
 */
...
function setTestEnv(): void {
  ...
  process.env.DB_USER = 'visiomath';
  process.env.DB_PASSWORD = 'visiomath_secret';
  process.env.DB_NAME = 'orchestration_test';
}
