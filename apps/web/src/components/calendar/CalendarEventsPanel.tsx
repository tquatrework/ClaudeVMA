...
/**
 * CalendarEventsPanel — extraction à l'identique du corps de CalendarPage (avant l'introduction
 * des onglets "Mes événements" / "Mes disponibilités"). Aucun changement de comportement.
 */
