 ...
 * les droits ne sont pas symétriques. Un formateur accède aux archives
 * pédagogiques de son élève ; l'élève n'accède PAS à celles de son formateur —
 * l'archive d'un formateur porte son historique d'exercice, elle ne regarde pas
 * ses élèves. Un booléen rendrait cette distinction impossible.
 */
 ...
 * place de ce service ce qu'un lien ouvre sur les archives.
 */
