 ...
 *   TEST_DB_PORT     → 5432
 *   TEST_DB_NAME     → video_session_test
...
function buildLocalDatabaseUrl(): string {
  ...
  const name     = process.env.TEST_DB_NAME     ?? 'video_session_test';
...
export const IDS = {
  ...
  // A known calendar session UUID used as calendarSessionId in room creation tests
  session1:  'a1b2c3d4-e5f6-4a7b-8c9d-e0f1a2b3c4d5',
};
