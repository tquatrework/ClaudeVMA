/**
 * TeacherAdministrativeStep — étape 1 (informations administratives) du wizard
 * d'inscription formateur.
...
export interface TeacherAdministrativeFormData {
  email: string
...
interface TeacherAdministrativeStepProps {
  administrativeData: TeacherAdministrativeFormData
  onChange: (field: keyof TeacherAdministrativeFormData, value: string) => void
...
export function TeacherAdministrativeStep({
  administrativeData,
  onChange,
  onEmailBlur,
  checkEmailError,
  isEmailAlreadyUsed,
  onSubmit,
}: TeacherAdministrativeStepProps) {
  return (
