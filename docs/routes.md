...
obligatoire (400 si vide) et unique par auteur (400 si un autre quizz du même auteur porte déjà ce
titre exact — ajouté le 2026-09-01, `docs/architecture.md` "Titre des Exercices et des Quizz").
