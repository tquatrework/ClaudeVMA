 ...
 * ouvrir un calendrier busy/free à un inconnu, soit à le fermer à quelqu'un
 * qui y a droit.
 *
 * Copié fidèlement depuis
 * `archive-document-service/src/common/clients/profile-relations.client.ts`
 * (arbitrage du chantier calendrier de disponibilités, point 2).
 */
